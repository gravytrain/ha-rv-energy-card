...
export class RvOutageMap extends LitElement {
  ...
  private _syncMap() {
    ...
    for (const outage of this.outages) {
      ...
      const marker = L.circleMarker([Number(point!.lat), Number(point!.lng)], { pane: 'outage-markers', radius: 9, color: 'var(--ink, #fff0df)', weight: 2, fillColor: 'var(--needle, #c8483a)', fillOpacity: 1 }).addTo(this._layers);
  ...
  static styles = css`
    :host,#outage-leaflet-map{display:block;height:100%;min-height:420px;background:var(--home-ui-map-background,#d7dde2);font-family:system-ui,sans-serif}.leaflet-container{position:relative;overflow:hidden}.leaflet-pane{z-index:400}.leaflet-tile-pane{z-index:200}.leaflet-overlay-pane{z-index:400}.leaflet-marker-pane{z-index:600}.leaflet-tooltip-pane{z-index:650}.leaflet-popup-pane{z-index:700}.leaflet-map-pane svg{z-index:200;pointer-events:auto}.leaflet-pane,.leaflet-layer,.leaflet-zoom-animated,.leaflet-tile,.leaflet-marker-icon,.leaflet-tile-container,.leaflet-pane>svg,.leaflet-pane>canvas{position:absolute;left:0;top:0}.leaflet-pane>svg,.leaflet-pane>canvas{width:100%;height:100%}.leaflet-tile-container{pointer-events:none}.leaflet-overlay-pane svg{max-width:none!important;max-height:none!important}.leaflet-control{position:relative;z-index:800}.leaflet-top,.leaflet-bottom{position:absolute;z-index:1000}.leaflet-top{top:0}.leaflet-right{right:0}.leaflet-bottom{bottom:0}.leaflet-left{left:0}.leaflet-control-zoom{margin:10px;border:1px solid var(--home-ui-map-control-border,#777);border-radius:4px;overflow:hidden;box-shadow:0 1px 5px var(--home-ui-map-control-border,#777)}.leaflet-control-zoom a{display:block;width:26px;height:26px;line-height:26px;text-align:center;background:var(--home-ui-map-control-background,#fff);color:var(--home-ui-map-control-text,#111);text-decoration:none;font-size:18px}.leaflet-control-zoom a+a{border-top:1px solid var(--home-ui-map-control-divider,#ccc)}.leaflet-control-attribution{margin:0;padding:2px 5px;background:color-mix(in srgb,var(--home-ui-map-control-background,#fff) 75%,transparent);font-size:11px;color:var(--home-ui-map-attribution-text,#333)}.leaflet-control-attribution a{color:var(--home-ui-map-link,#0078a8)}.leaflet-popup{position:absolute;text-align:center;margin-bottom:20px}.leaflet-popup-content-wrapper{padding:1px;text-align:left;border-radius:5px;background:var(--panel,#20242b);color:var(--ink,#e7e3d8);box-shadow:0 3px 14px color-mix(in srgb,var(--home-ui-shadow,#000) 40%,transparent)}.leaflet-popup-content{margin:12px 14px;line-height:1.45}.leaflet-popup-tip{width:12px;height:12px;margin:-6px auto 0;background:var(--panel,#20242b);transform:rotate(45deg)}.leaflet-popup-close-button{position:absolute;right:4px;top:0;color:var(--brass,#d9a441);font-size:18px;text-decoration:none}.leaflet-tooltip{position:absolute;padding:5px 7px;border:1px solid var(--brass,#d9a441);border-radius:3px;background:var(--housing,#14161b);color:var(--ink,#e7e3d8);font:11px system-ui,sans-serif;box-shadow:0 2px 7px color-mix(in srgb,var(--home-ui-shadow,#000) 40%,transparent)}.home-marker{width:auto!important;height:auto!important;margin:-12px 0 0 -18px!important;padding:4px 7px;border:2px solid var(--ink,#fff0df);border-radius:14px;background:var(--needle,#c8483a);color:var(--home-ui-danger-ink,#fff);font:700 10px system-ui,sans-serif;box-shadow:0 1px 5px color-mix(in srgb,var(--home-ui-shadow,#000) 50%,transparent);white-space:nowrap}
  `;
}
